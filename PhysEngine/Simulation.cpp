...
//                };
//
//                d.collisions[i + 12] = collision;
//            }
//        }
//
//        for (int i = 0; i < 16; i++) {
//            if (!d.collisions[i].bodyA) { continue; }
//
//            AddCollision(d.collisions[i]);
//        }
//    }
//}
//
